			...
			<Reveal as="div" className="max-w-5xl mx-auto text-center">
				...
				<div className="flex flex-wrap justify-center gap-4">
					<a
						...
						className="flex items-center gap-2 font-mono text-sm px-5 py-2.5 rounded border border-signal text-signal hover:bg-signal hover:text-ink transition-colors"
					>
					...
					<a
						...
						target="_blank"
						rel="noreferrer"
						className="flex items-center gap-2 font-mono text-sm px-5 py-2.5 rounded border border-line text-muted hover:text-text hover:border-text transition-colors"
					>
